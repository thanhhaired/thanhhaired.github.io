...
function laborator_custom_css_page() {
	...
	if ( 0 == get_option( 'laborator_custom_css_status', 1 ) && kalium()->url->get( 'tab' ) != 'settings' ) {
		?>
        <div class="notice notice-warning">
            <p>Custom CSS is currently disabled. You can change this <a
                        href="<?php echo admin_url( 'admin.php?page=laborator_custom_css&tab=settings' ); ?>">here
                    &raquo;</a></p>
        </div>
		<?php
	}
	...
	if ( kalium()->url->get( 'tab' ) == 'settings' ) {
