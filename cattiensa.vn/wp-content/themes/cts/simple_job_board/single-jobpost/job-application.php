...
<div class="row">
	<div class="col-md-6"><div class="btn-cattiensa" id="btn-toggle-job-form">NỘP HỒ SƠ ONLINE</div></div>
	<div class="col-md-6"><a href="mailto:hr@cattiensa.com"><div class="btn-cattiensa">NỘP HỒ SƠ QUA EMAIL</div></a></div>
</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group" id="sjb-form-padding-button">
                <button class="app-submit btn-cattiensa"><?php esc_html_e('Submit', 'simple-job-board'); ?></button>
            </div>
        </div>
    </div>
</form>
